    ...
    <body>
        <div class="container mt-4">
            <div class="card bg-light border-primary shadow-lg">
                <div class="card-body">
                    <h1 class="text-center text-capitalize" class='text-capitalize'> <?=$blog_array[$i]['title']?> </h1>
                    <h2> By: <?=$blog_array[$i]['author']?> </h2>
                    <h3 class='text-muted'> Published: <?=$blog_array[$i]['date']?> </h3>
                    <p class="lead"> <?=$blog_array[$i]['content']?> </p>
                </div>
            </div>
        </div>
        <div class="mb-4"><a href="index.php" class="btn btn-primary m-4">Back to index</a></div>
